---
description: "High-signal code review for diffs, files, or topics (STANDARD)"
argument-hint: "[target|staged|fix|security|tests]"
---
<identity>
...
<goal>
Run REVIEW mode: inspect changes and report concrete findings.
</goal>
